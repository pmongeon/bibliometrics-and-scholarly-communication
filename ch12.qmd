...
@babbage1830 described two types of falsification. The first one, cooking, consists of cherry-picking data to achieve a desired finding. The second, which Babbage called trimming, consists of eliminating data points that deviate from the average to artificially increase the precision and homogeneity of the data. @larivée1993 argue that falsification is not only about cooking and trimming data but can also include the misuse of statistical tests or the altering of equipment or data collection processes. The main difference between falsification and fabrication is that falsification involves real data, whereas fabrication involves artificially created data.
...
Plagiarism, which is said to be the most frequent type of scientific fraud [@merton1957a] , can be defined as:
...
For the guilty researchers, fraud has informal consequences in the form of a loss of reputation [@larivée1993] and the questioning of all their work by the scientific community [@culliton1974]. There are also formal consequences that vary from case to case. These can include a ban on obtaining funding for a certain number of years, suspension, dismissal, house arrest, community service, fines, and imprisonment [@couzin2006; @karcz2011; @tilden2010]. @mongeon2015 found that most researchers found guilty of fraud in the biomedical field did not publish in the 5 years following the retraction of their fraudulent papers. That same study found that fraud can also significantly affect the careers of innocent co-authors, especially junior researchers who, in most cases, stopped publishing and appear to have abandoned their research careers (see the figure below).
...
Funding for research comes largely from public funds, and it is important that science be seen as trustworthy by governments, funding agencies and the public. Research fraud, and especially the cases that generate a lot of media coverage, can harm the credibility and legitimacy of science.

## Detecting research fraud?

Given the significant consequences that research fraud can have, it is important that the scientific community be able to detect it. It is sometimes taken for granted that science is self-correcting and has mechanisms that will ensure that sooner or later errors (and frauds) will be discovered. However, the surge of research fraud observed over the last decades raises questions as to the effectiveness of these mechanisms.
...
![Research behaviours continuum](images/steneck_2006.jpg){fig-align="center" width="400"}
...
-   **Selective reporting**: Reporting only some of the data and results of a study (typically only the positive results). Failing to provide an adequate level of details in the different parts of the manuscript. Publishing only positive results (publication bias).
...
-   **Not sharing data**: While sharing data is not always possible for ethical or legal reasons, sharing data is increasingly expected by journals and also increasingly required by funders. The Tri-Agency Research Data Management Policy, for example, encourages the creation of FAIR (Findable, Accessible, Interoperable, and Reusable) data.
