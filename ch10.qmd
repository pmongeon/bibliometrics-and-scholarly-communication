...
-   The [Simple Query Tool](https://unpaywall.org/products/simple-query-tool) that allows you to simply paste a list of DOI and get the data by email.
...
-   Unpaywall data is also integrated into [[OpenAlex]{.underline}](https://docs.openalex.org/about-the-data/work#the-openaccess-object "https://docs.openalex.org/api-entities/works/work-object#open_access")and provides the following metadata on the OA status of articles:
